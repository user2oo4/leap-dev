...
ZSampler = DWaveSampler(solver={'topology__type': 'zephyr'})
...
CUR_SAMPLER = ZSampler



for i in range(0,512):
    if (i in CUR_SAMPLER.nodelist):
        graph_nodes[i]=0
...
for cstr in cstr_list:
    ...
    # print(model)
        ...
        sample_result = CUR_SAMPLER.sample(model, num_reads=100, annealing_time = at)
